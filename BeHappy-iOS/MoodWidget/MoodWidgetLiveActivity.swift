...
struct MoodWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = MoodWidgetAttributes(name: "Me")
    static let contentState = MoodWidgetAttributes.ContentState(value: 3)
